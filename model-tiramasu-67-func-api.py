...
class Tiramisu():
    ...
    def create(self):
        ...
        layer_1_down = self.DenseBlock(5, 58, first_conv, enc_model_layers, 'layer_1_down')  # 5*12 = 60 + 48 = 108
        layer_1a_down = self.TransitionDown(58, layer_1_down, enc_model_layers, 'layer_1a_down')

        layer_2_down = self.DenseBlock(5, 68, layer_1a_down, enc_model_layers, 'layer_2_down')  # 5*12 = 60 + 108 = 168
        layer_2a_down = self.TransitionDown(68, layer_2_down, enc_model_layers, 'layer_2a_down')

        layer_3_down = self.DenseBlock(5, 78, layer_2a_down, enc_model_layers, 'layer_3_down')  # 5*12 = 60 + 168 = 228
        layer_3a_down = self.TransitionDown(78, layer_3_down, enc_model_layers, 'layer_3a_down')

        layer_4_down = self.DenseBlock(5, 88, layer_3a_down, enc_model_layers, 'layer_4_down')  # 5*12 = 60 + 228 = 288
        layer_4a_down = self.TransitionDown(88, layer_4_down, enc_model_layers, 'layer_4a_down')

        layer_5_down = self.DenseBlock(5, 98, layer_4a_down, enc_model_layers, 'layer_5_down')  # 5*12 = 60 + 288 = 348
        layer_5a_down = self.TransitionDown(98, layer_5_down, enc_model_layers, 'layer_5a_down')

        layer_bottleneck = self.DenseBlock(15, 108, layer_5a_down, enc_model_layers,
                                           'layer_bottleneck')  # m = 348 + 5*12 = 408

        layer_1_up = self.TransitionUp(118, (118, 7, 7), (None, 118, 14, 14), layer_bottleneck, enc_model_layers,
                                       'layer_1_up')  # m = 348 + 5x12 + 5x12 = 468.
        skip_up_down_1 = concatenate([layer_1_up, enc_model_layers['layer_5_down']['conv' + str(5)]], axis=-1)
        layer_1a_up = self.DenseBlock(5, 118, skip_up_down_1, enc_model_layers, 'layer_1a_up')

        layer_2_up = self.TransitionUp(108, (108, 14, 14), (None, 108, 28, 28), layer_1a_up, enc_model_layers,
                                       'layer_2_up')  # m = 288 + 5x12 + 5x12 = 408
        skip_up_down_2 = concatenate([layer_2_up, enc_model_layers['layer_4_down']['conv' + str(5)]], axis=-1)
        layer_2a_up = self.DenseBlock(5, 108, skip_up_down_2, enc_model_layers, 'layer_2a_up')

        layer_3_up = self.TransitionUp(98, (98, 28, 28), (None, 98, 56, 56), layer_2a_up, enc_model_layers,
                                       'layer_3_up')  # m = 228 + 5x12 + 5x12 = 348
        skip_up_down_3 = concatenate([layer_3_up, enc_model_layers['layer_3_down']['conv' + str(5)]], axis=-1)
        layer_3a_up = self.DenseBlock(5, 98, skip_up_down_3, enc_model_layers, 'layer_3a_up')

        layer_4_up = self.TransitionUp(88, (88, 56, 56), (None, 88, 112, 112), layer_3a_up, enc_model_layers,
                                       'layer_4_up')  # m = 168 + 5x12 + 5x12 = 288
        skip_up_down_4 = concatenate([layer_4_up, enc_model_layers['layer_2_down']['conv' + str(5)]], axis=-1)
        layer_4a_up = self.DenseBlock(5, 88, skip_up_down_4, enc_model_layers, 'layer_4a_up')

        layer_5_up = self.TransitionUp(78, (78, 112, 112), (None, 78, 224, 224), layer_4a_up, enc_model_layers,
                                       'layer_5_up')  # m = 108 + 5x12 + 5x12 = 228
        skip_up_down_5 = concatenate([layer_5_up, enc_model_layers['layer_1_down']['conv' + str(5)]], axis=-1)
        layer_5a_up = self.DenseBlock(5, 78, skip_up_down_5, enc_model_layers, 'concatenate')

        # last
        last_conv = Conv2D(2, activation='linear',
                           kernel_size=(1, 1),
                           padding='same',
                           kernel_regularizer=l2(0.0001),
                           data_format='channels_last')(layer_5a_up)

        # reshape = Reshape((224, 224,1))(last_conv)
